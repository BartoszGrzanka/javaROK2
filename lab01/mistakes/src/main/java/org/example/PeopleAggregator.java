...
public class PeopleAggregator {
    ...
    public Map<Gender, List<Person>> aggregatePeopleByGender(){
        List<Person> newListOfPeopleF = new ArrayList<>();
        List<Person> newListOfPeopleM = new ArrayList<>();

        Map<Gender, List<Person>> aggregatedByGender = new HashMap<>();

        aggregatedByGender.put(Gender.FEMALE, newListOfPeopleF);
        aggregatedByGender.put(Gender.MALE, newListOfPeopleM);
